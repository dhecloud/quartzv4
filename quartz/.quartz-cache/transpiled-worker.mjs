...
function slugifyFilePath(fp, excludeExt) {
  ...
  let slug2 = withoutFileExt.split("/").map((segment) => segment.replace(/\s/g, "-").replace(/%/g, "-percent").replace(/\?/g, "-q")).join("/").replace(/\/$/, "");
...
var tagRegex = new RegExp(/(?:^| )#((?:[-_\p{L}\d])+(?:\/[-_\p{L}\d]+)*)/, "gu");
              ...
              if (value.startsWith("!")) {
                ...
                if ([".png", ".jpg", ".jpeg", ".gif", ".bmp", ".svg"].includes(ext)) {
                  ...
                  return {
                    ...
                    value: `<blockquote class="transclude" data-url="${url2}" data-block="${block}"><a href="${url2 + anchor}" class="transclude-inner">Transclude of block ${block}</a></blockquote>`
                  };
                }
              }
              const url = fp + anchor;
  ...
  visit4(componentData.tree, "element", (node, _index, _parent) => {
    if (node.tagName === "blockquote") {
      ...
      if (classNames.includes("transclude")) {
        ...
        const blockSlug = inner.properties?.["data-slug"];
        const blockRef = node.properties.dataBlock;
...
function Content({ tree }) {
  const content = toJsxRuntime(tree, { Fragment, jsx: jsx5, jsxs: jsxs2, elementAttributeNameCase: "html" });
  return /* @__PURE__ */ jsx6("article", { class: "popover-hint", children: content });
}
__name(Content, "Content");
var Content_default = /* @__PURE__ */ __name(() => Content, "default");

// quartz/components/pages/TagContent.tsx
import { Fragment as Fragment3, jsx as jsx9, jsxs as jsxs4 } from "preact/jsx-runtime";
...
import { Fragment as Fragment2, jsx as jsx7 } from "preact/jsx-runtime";
...
function Date2({ date }) {
  return /* @__PURE__ */ jsx7(Fragment2, { children: formatDate(date) });
}
__name(Date2, "Date");
...
function PageList({ cfg, fileData, allFiles, limit }) {
  ...
  return /* @__PURE__ */ jsx8("ul", { class: "section-ul", children: list.map((page) => {
    const title = page.frontmatter?.title;
    const tags = page.frontmatter?.tags ?? [];
    return /* @__PURE__ */ jsx8("li", { class: "section-li", children: /* @__PURE__ */ jsxs3("div", { class: "section", children: [
      page.dates && /* @__PURE__ */ jsx8("p", { class: "meta", children: /* @__PURE__ */ jsx8(Date2, { date: getDate(cfg, page) }) }),
      /* @__PURE__ */ jsx8("div", { class: "desc", children: /* @__PURE__ */ jsx8("h3", { children: /* @__PURE__ */ jsx8("a", { href: resolveRelative(fileData.slug, page.slug), class: "internal", children: title }) }) }),
      /* @__PURE__ */ jsx8("ul", { class: "tags", children: tags.map((tag) => /* @__PURE__ */ jsx8("li", { children: /* @__PURE__ */ jsxs3(
        "a",
        {
...
function TagContent(props) {
  ...
  const content = tree.children.length === 0 ? fileData.description : (
    // @ts-ignore
    toJsxRuntime2(tree, { Fragment: Fragment3, jsx: jsx9, jsxs: jsxs4, elementAttributeNameCase: "html" })
  );
  if (tag === "") {
    ...
    return /* @__PURE__ */ jsxs5("div", { class: "popover-hint", children: [
      ...
      /* @__PURE__ */ jsx10("div", { children: tags.map((tag2) => {
        ...
        return /* @__PURE__ */ jsxs5("div", { children: [
          /* @__PURE__ */ jsx10("h2", { children: /* @__PURE__ */ jsxs5("a", { class: "internal tag-link", href: `./${tag2}`, children: [
            "#",
            tag2
          ] }) }),
...
import { Fragment as Fragment4, jsx as jsx11, jsxs as jsxs6 } from "preact/jsx-runtime";
...
function FolderContent(props) {
  ...
  const content = tree.children.length === 0 ? fileData.description : (
    // @ts-ignore
    toJsxRuntime3(tree, { Fragment: Fragment4, jsx: jsx11, jsxs: jsxs6, elementAttributeNameCase: "html" })
  );
  return /* @__PURE__ */ jsxs7("div", { class: "popover-hint", children: [
    /* @__PURE__ */ jsx12("article", { children: /* @__PURE__ */ jsx12("p", { children: content }) }),
    /* @__PURE__ */ jsxs7("p", { children: [
      pluralize(allPagesInFolder.length, "item"),
      " under this folder."
    ] }),
    /* @__PURE__ */ jsx12("div", { children: /* @__PURE__ */ jsx12(PageList, { ...listProps }) })
  ] });
}
...
import { jsx as jsx13, jsxs as jsxs8 } from "preact/jsx-runtime";
function NotFound() {
  return /* @__PURE__ */ jsxs8("article", { class: "popover-hint", children: [
    /* @__PURE__ */ jsx13("h1", { children: "404" }),
    /* @__PURE__ */ jsx13("p", { children: "Either this page is private or doesn't exist." })
  ] });
}
...
function ArticleTitle({ fileData, displayClass }) {
  ...
  if (title) {
    return /* @__PURE__ */ jsx14("h1", { class: `article-title ${displayClass ?? ""}`, children: title });
  } else {
    return null;
  }
}
...
function Darkmode({ displayClass }) {
  return /* @__PURE__ */ jsxs9("div", { class: `darkmode ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsx15("input", { class: "toggle", id: "darkmode-toggle", type: "checkbox", tabIndex: -1 }),
    /* @__PURE__ */ jsx15("label", { id: "toggle-label-light", for: "darkmode-toggle", tabIndex: -1, children: /* @__PURE__ */ jsxs9(
      "svg",
      {
        ...
        xmlSpace: "preserve",
        children: [
          /* @__PURE__ */ jsx15("title", { children: "Light mode" }),
    ...
    /* @__PURE__ */ jsx15("label", { id: "toggle-label-dark", for: "darkmode-toggle", tabIndex: -1, children: /* @__PURE__ */ jsxs9(
      "svg",
      {
        xmlns: "http://www.w3.org/2000/svg",
        xmlnsXlink: "http://www.w3.org/1999/xlink",
        ...
        xmlSpace: "preserve",
        children: [
          /* @__PURE__ */ jsx15("title", { children: "Dark mode" }),
...
import { jsx as jsx16, jsxs as jsxs10 } from "preact/jsx-runtime";
var Head_default = /* @__PURE__ */ __name(() => {
  function Head({ cfg, fileData, externalResources }) {
    ...
    return /* @__PURE__ */ jsxs10("head", { children: [
      ...
      cfg.baseUrl && /* @__PURE__ */ jsx16("meta", { property: "og:image", content: ogImagePath }),
      /* @__PURE__ */ jsx16("meta", { property: "og:width", content: "1200" }),
      /* @__PURE__ */ jsx16("meta", { property: "og:height", content: "675" }),
      ...
      css.map((href) => /* @__PURE__ */ jsx16("link", { href, rel: "stylesheet", type: "text/css", "spa-preserve": true }, href)),
...
function PageTitle({ fileData, cfg, displayClass }) {
  ...
  return /* @__PURE__ */ jsx17("h1", { class: `page-title ${displayClass ?? ""}`, children: /* @__PURE__ */ jsx17("a", { href: baseDir, children: title }) });
}
...
var ContentMeta_default = /* @__PURE__ */ __name(() => {
  function ContentMetadata({ cfg, fileData, displayClass }) {
    ...
    if (text) {
      ...
      return /* @__PURE__ */ jsx18("p", { class: `content-meta ${displayClass ?? ""}`, children: segments.join(", ") });
    } else {
      return null;
    }
  }
...
function Spacer({ displayClass }) {
  return /* @__PURE__ */ jsx19("div", { class: `spacer ${displayClass ?? ""}` });
}
...
import { jsx as jsx20, jsxs as jsxs11 } from "preact/jsx-runtime";
var defaultOptions8 = {
  layout: "modern"
};
function TableOfContents2({ fileData, displayClass }) {
  ...
  return /* @__PURE__ */ jsxs11("div", { class: `toc ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsxs11("button", { type: "button", id: "toc", children: [
      /* @__PURE__ */ jsx20("h3", { children: "Table of Contents" }),
      /* @__PURE__ */ jsx20(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
    ...
    /* @__PURE__ */ jsx20("div", { id: "toc-content", children: /* @__PURE__ */ jsx20("ul", { class: "overflow", children: fileData.toc.map((tocEntry) => /* @__PURE__ */ jsx20("li", { class: `depth-${tocEntry.depth}`, children: /* @__PURE__ */ jsx20("a", { href: `#${tocEntry.slug}`, "data-for": tocEntry.slug, children: tocEntry.text }) }, tocEntry.slug)) }) })
  ] });
}
...
function LegacyTableOfContents({ fileData }) {
  ...
  return /* @__PURE__ */ jsxs11("details", { id: "toc", open: true, children: [
    /* @__PURE__ */ jsx20("summary", { children: /* @__PURE__ */ jsx20("h3", { children: "Table of Contents" }) }),
...
import { jsx as jsx21, jsxs as jsxs12 } from "preact/jsx-runtime";
  ...
  insert(file) {
    if (file.path.length === 1) {
      if (file.path[0] !== "index.md") {
        this.children.push(new _FileNode(file.file.frontmatter.title, file.file, this.depth + 1));
      } else {
      ...
      const newChild = new _FileNode(next, void 0, this.depth + 1);
...
function ExplorerNode({ node, opts, fullPath, fileData }) {
  ...
  return /* @__PURE__ */ jsx21("li", { children: node.file ? (
    // Single file node
    ...
    /* @__PURE__ */ jsxs12("div", { class: "folder-container", children: [
      /* @__PURE__ */ jsx21(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
      ...
      /* @__PURE__ */ jsx21("div", { "data-folderpath": folderPath, children: folderBehavior === "link" ? /* @__PURE__ */ jsx21("a", { href: `${folderPath}`, "data-for": node.name, class: "folder-title", children: node.displayName }) : /* @__PURE__ */ jsx21("button", { class: "folder-button", children: /* @__PURE__ */ jsx21("p", { class: "folder-title", children: node.displayName }) }) }, node.name)
    ] }),
...
import { jsx as jsx22, jsxs as jsxs13 } from "preact/jsx-runtime";
var defaultOptions9 = {
  title: "Explorer",
...
var Explorer_default = /* @__PURE__ */ __name((userOpts) => {
  ...
  function Explorer({ allFiles, displayClass, fileData }) {
    ...
    return /* @__PURE__ */ jsxs13("div", { class: `explorer ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsxs13(
        "button",
        {
          type: "button",
          ...
          "data-tree": jsonTree,
          children: [
            /* @__PURE__ */ jsx22("h1", { children: opts.title }),
            /* @__PURE__ */ jsx22(
              "svg",
              {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      /* @__PURE__ */ jsx22("div", { id: "explorer-content", children: /* @__PURE__ */ jsxs13("ul", { class: "overflow", id: "explorer-ul", children: [
...
function TagList({ fileData, displayClass }) {
  ...
  if (tags && tags.length > 0) {
    return /* @__PURE__ */ jsx23("ul", { class: `tags ${displayClass ?? ""}`, children: tags.map((tag) => {
      const display = `#${tag}`;
      const linkDest = baseDir + `/tags/${slugTag(tag)}`;
      return /* @__PURE__ */ jsx23("li", { children: /* @__PURE__ */ jsx23("a", { href: linkDest, class: "internal tag-link", children: display }) });
    }) });
  } else {
    return null;
  }
...
var Graph_default = /* @__PURE__ */ __name((opts) => {
  function Graph({ displayClass }) {
    ...
    return /* @__PURE__ */ jsxs14("div", { class: `graph ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsx24("h3", { children: "Graph View" }),
      /* @__PURE__ */ jsxs14("div", { class: "graph-outer", children: [
...
import { jsx as jsx25, jsxs as jsxs15 } from "preact/jsx-runtime";
function Backlinks({ fileData, allFiles, displayClass }) {
  ...
  return /* @__PURE__ */ jsxs15("div", { class: `backlinks ${displayClass ?? ""}`, children: [
    /* @__PURE__ */ jsx25("h3", { children: "Backlinks" }),
    /* @__PURE__ */ jsx25("ul", { class: "overflow", children: backlinkFiles.length > 0 ? backlinkFiles.map((f) => /* @__PURE__ */ jsx25("li", { children: /* @__PURE__ */ jsx25("a", { href: resolveRelative(fileData.slug, f.slug), class: "internal", children: f.frontmatter?.title }) })) : /* @__PURE__ */ jsx25("li", { children: "No backlinks found" }) })
  ] });
}
...
import { jsx as jsx26, jsxs as jsxs16 } from "preact/jsx-runtime";
var Search_default = /* @__PURE__ */ __name(() => {
  function Search({ displayClass }) {
    return /* @__PURE__ */ jsxs16("div", { class: `search ${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsxs16("div", { id: "search-icon", children: [
        /* @__PURE__ */ jsx26("p", { children: "Search" }),
        /* @__PURE__ */ jsx26("div", {}),
        /* @__PURE__ */ jsxs16(
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ jsx26("title", { id: "title", children: "Search" }),
              /* @__PURE__ */ jsx26("desc", { id: "desc", children: "Search" }),
              /* @__PURE__ */ jsxs16("g", { class: "search-path", fill: "none", children: [
      ...
      /* @__PURE__ */ jsx26("div", { id: "search-container", children: /* @__PURE__ */ jsxs16("div", { id: "search-space", children: [
        /* @__PURE__ */ jsx26(
          "input",
          {
            autocomplete: "off",
...
var Footer_default = /* @__PURE__ */ __name((opts) => {
  function Footer({ displayClass }) {
    ...
    return /* @__PURE__ */ jsxs17("footer", { class: `${displayClass ?? ""}`, children: [
      /* @__PURE__ */ jsx27("hr", {}),
      /* @__PURE__ */ jsxs17("p", { children: [
        "Created with ",
        /* @__PURE__ */ jsxs17("a", { href: "https://quartz.jzhao.xyz/", children: [
          "Quartz v",
          version
        ] }),
        ", \xA9 ",
...
import { jsx as jsx30, jsxs as jsxs18 } from "preact/jsx-runtime";

// quartz/components/styles/breadcrumbs.scss
var breadcrumbs_default = "";

// quartz/components/Breadcrumbs.tsx
import { Fragment as Fragment7, jsx as jsx31, jsxs as jsxs19 } from "preact/jsx-runtime";
...
function findCurrentFile(allFiles, folderName) {
...
__name(findCurrentFile, "findCurrentFile");
  ...
  function Breadcrumbs({ fileData, allFiles, displayClass }) {
    ...
    if (slugParts) {
      ...
      for (let i = 0; i < slugParts.length - 1; i++) {
        ...
        if (options2?.resolveFrontmatterTitle) {
        ...
        const crumb = formatCrumb(currentTitle, fileData.slug, currentPath);
        crumbs.push(crumb);
      }
      crumbs.push({
    ...
    return /* @__PURE__ */ jsx31("nav", { class: `breadcrumb-container ${displayClass ?? ""}`, "aria-label": "breadcrumbs", children: crumbs.map((crumb, index) => /* @__PURE__ */ jsxs19("div", { class: "breadcrumb-element", children: [
...
var sharedPageComponents = {
  ...
  footer: Footer_default({
    links: {
      ...
      "aibrain": "https://aibrain.dhecloud.xyz/"
    }
  })
};
  ...
  return {
    ...
    async emit(ctx, content, resources, emit) {
      ...
      for (const [tree, file] of content) {
        ...
        const externalResources = pageResources(pathToRoot(slug2), resources);
        const componentData = {
          fileData: file.data,
          externalResources,
          cfg,
...
function generateRSSFeed(cfg, idx, limit) {
  ...
  const items = Array.from(idx).map(([slug2, content]) => createURLEntry(simplifySlug(slug2), content)).slice(0, limit ?? idx.size).join("");
...
var Static = /* @__PURE__ */ __name(() => ({
  ...
  async emit({ argv, cfg }, _content, _resources, _emit) {
    ...
    await fs3.promises.cp(staticPath, joinSegments(argv.output, "static"), { recursive: true });
...
var ComponentResources = /* @__PURE__ */ __name((opts) => {
  const { fontOrigin } = { ...defaultOptions13, ...opts };
  return {
    ...
    async emit(ctx, _content, resources, emit) {
      ...
      const stylesheet = joinStyles(ctx.cfg.configuration.theme, custom_default, ...componentResources.css);
...
var NotFoundPage = /* @__PURE__ */ __name(() => {
  ...
  return {
    ...
    async emit(ctx, _content, resources, emit) {
      ...
      return [
        await emit({
          content: renderPage(slug2, componentData, opts, externalResources),
          slug: slug2,
          ext: ".html"
        })
      ];
...
var PerfTimer = class {
  ...
  timeSince(evtName) {
    return chalk3.yellow(pretty(process.hrtime(this.evts[evtName ?? "start"])));
  }
};
...
function trace(msg, err) {
  ...
  lines.push("");
  lines.push(
    "\n" + chalk4.bgRed.black.bold(" ERROR ") + "\n" + chalk4.red(` ${msg}`) + (err.message.length > 0 ? `: ${err.message}` : "")
  );
  if (!stack) {
    return;
  }
